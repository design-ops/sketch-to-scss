...
async function processTextStyles(textStyles, fontReferences, outputFolder, sketchFile, base64) {
    let ret = []
    ...
    let fonts = await copyFonts(fontNames, { sketchFile, usedFontReferences }, outputFolder, base64)

    // let fonts = convertFonts()
